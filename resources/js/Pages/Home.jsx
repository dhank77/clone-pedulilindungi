...
export default function Home() {
    ...
    return (
        <App title="My Blog">
            <div className="bg-white rounded-xl px-2 w-1/4 flex justify-between flex-col">
                <div className="p-5">
                    <h4>M. Hamdani Ilham Latjoro</h4>
                </div>
                <hr />
                <div className="flex flex-col items-center py-5">
                    <Link className="px-4 py-5 hover:bg-blue-400 rounded-lg w-full" href="#">
                        <div className="flex">
                            <div className="mr-4">
                ...
                <hr />
                <Link className="flex px-4 my-2 py-5 hover:bg-blue-400 rounded-lg w-full">
